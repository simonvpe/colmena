{ config, pkgs, backlight, background, ... }:
...
''
  ...
  # Adjust backlight
  bindsym XF86MonBrightnessUp exec --no-startup-id ${backlight.increase} &> /tmp/inc
  bindsym XF86MonBrightnessDown exec --no-startup-id ${backlight.decrease} &> /tmp/dec
